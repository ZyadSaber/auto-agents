...
const resources = {
  en: {
    translation: {
      ...
      "chat_empty_heading":      "How can I help you today?",
      "chat_empty_hint":         "Start typing below",
      "chat_enter_to_send":      "to send",
      "chat_shift_enter":        "for new line",
      "chat_local_ai":           "Local AI",
      "chat_smart_routing":      "Smart Routing",
      "chat_status_thinking":    "Thinking…",
      "chat_status_generating":  "Generating",
      "chat_status_error":       "Error",
      "chat_status_ready":       "Ready",
      "chat_disclaimer":         "AI can make mistakes — verify important information.",
      "chat_panel_model":        "Model",
      "chat_active_model":       "Active Model",
      "chat_model_placeholder":  "Select a model",
      "chat_routing_label":      "Routing",
      "chat_routing_auto":       "✨ Smart Routing",
      "chat_routing_missing":    "✨ Smart Routing (models missing)",
      "chat_routing_hint":       "Auto picks Arabic or English model based on your message.",
      "chat_routing_warn":       "Smart Routing needs {{arabic}} and {{english}} pulled in Ollama.",
      "chat_models_label":       "Available Models",
      "chat_session_label":      "Session",
      "chat_session_messages":   "Messages",
      "chat_session_storage":    "Storage",
      "chat_session_local":      "Local",
      "chat_session_hint":       "History is saved locally in your browser.",
      "chat_actions_label":      "Actions",
      "chat_clear_messages":     "Clear Messages",
      "chat_error_unreachable":  "⚠️ Could not reach the AI server.",

      // ── Ask placeholder (reused in Chat) ──────────────────────────────────
  ...
  ar: {
    translation: {
      ...
      // ── Header ────────────────────────────────────────────────────────────
      "header_toggle_sidebar": "إخفاء/إظهار القائمة",
      "header_lang_en":        "EN",
      "header_lang_ar":        "AR",
      ...
      "chat_history":            "السجل",
      "chat_empty_heading":      "كيف يمكنني مساعدتك اليوم؟",
      "chat_empty_hint":         "ابدأ الكتابة أدناه",
      "chat_enter_to_send":      "للإرسال",
      "chat_shift_enter":        "لسطر جديد",
      "chat_local_ai":           "ذكاء اصطناعي محلي",
      "chat_smart_routing":      "توجيه ذكي",
      "chat_status_thinking":    "جاري التفكير…",
      "chat_status_generating":  "جاري التوليد",
      "chat_status_error":       "خطأ",
      "chat_status_ready":       "جاهز",
      "chat_disclaimer":         "قد يخطئ الذكاء الاصطناعي — تحقق من المعلومات المهمة.",
      "chat_panel_model":        "النموذج",
      "chat_active_model":       "النموذج النشط",
      "chat_model_placeholder":  "اختر نموذجاً",
      "chat_routing_label":      "التوجيه",
      "chat_routing_auto":       "✨ توجيه ذكي",
      "chat_routing_missing":    "✨ التوجيه الذكي (نماذج مفقودة)",
      "chat_routing_hint":       "يختار النموذج الأنسب تلقائياً بناءً على لغة رسالتك.",
      "chat_routing_warn":       "التوجيه الذكي يحتاج {{arabic}} و {{english}} في Ollama.",
      "chat_models_label":       "النماذج المتاحة",
      "chat_session_label":      "الجلسة",
      "chat_session_messages":   "الرسائل",
      "chat_session_storage":    "التخزين",
      "chat_session_local":      "محلي",
      "chat_session_hint":       "يتم حفظ السجل محلياً في متصفحك.",
      "chat_actions_label":      "الإجراءات",
      "chat_clear_messages":     "مسح الرسائل",
      "chat_error_unreachable":  "⚠️ تعذّر الوصول إلى خادم الذكاء الاصطناعي.",
